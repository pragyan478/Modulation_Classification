...
for snr = 1:35
    ...
    for k = 1:100
        data = data_generation_25classes(N,snr);
        sig1 = data(:,1);
        sig2 = data(:,2);
        sig3 = data(:,3);
        sig4 = data(:,4);
    ...
    avg = (accuracy_y1 + accuracy_y2 + accuracy_y3 + accuracy_y4 + accuracy_y5 + accuracy_y6 + accuracy_y7 + accuracy_y8 + accuracy_y9 + accuracy_y10 + accuracy_y11 + accuracy_y12 + accuracy_y13 + accuracy_y14 + accuracy_y15 + accuracy_y16 + accuracy_y21)/17;
