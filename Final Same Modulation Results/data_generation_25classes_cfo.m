...
for j=1:length(h1) %doubt?
    ...
    for q=1:runs
        ...
        ModData_8qam1=qammod(dataSymbolsIn81,M5,'UnitAveragePower',true);
...
%         two lines.
        ...
        qwe = scale.*qwe1.*cfo' + qwe2*exp(1i*theta2);
       ...
       qwe = scale.*qwe1.*cfo' + qwe2*exp(1i*theta2);
        ...
        %8QAM-8QAM
        qwe2 = upfirdn(ModData_8qam2, rrcFilterShifted2,sps);
        qwe1 = upfirdn(ModData_8qam1, rrcFilterShifted1,sps);
        ...
        t4 = upfirdn(qwe,rrcFilter,1,sps);
        %length(t4)
        %16QAM-16QAM
        ...
        y3 = y33(21:end-20);
        snr = sigtonoise + 10*log10(k5)- 10*log10(sps);
        y44=awgn(t4,snr,'measured');
        y4 = y44(21:end-20);
