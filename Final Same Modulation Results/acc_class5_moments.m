...
cfo = [0.001 0.0006 0.0003 0.0001];
...
title(strcat(strcat('Average Accuracy N = ',num2str(N)),strcat(',sps = 16,Weaker User Timing Offset =',num2str(off))));
xlabel('SNR')
ylabel('Accuracy(in %)')
hold on
grid on
...
legend({'CFO = 0.001','CFO = 0.0006','CFO = 0.0003','CFO = 0.0001'},'Location','southeast')
i = i+1;
figure()

for i =1:length(cfo)
plot(sigma,acc_1(i,:),'-o')
title(strcat(strcat('BPSK-BPSK N = ',num2str(N)),strcat(',sps = 16,Weaker User Timing Offset =',num2str(off))));
...
title(strcat(strcat('QPSK-QPSK N = ',num2str(N)),strcat(',sps = 16,Weaker User Timing Offset =',num2str(off))));
...
title(strcat(strcat('8PSK-8PSK N = ',num2str(N)),strcat(',sps = 16,Weaker User Timing Offset =',num2str(off))));
...
title(strcat(strcat('8QAM-8QAM N = ',num2str(N)),strcat(',sps = 16,Weaker User Timing Offset =',num2str(off))));
...
title(strcat(strcat('16QAM-16QAM N = ',num2str(N)),strcat(',sps = 16,Weaker User Timing Offset =',num2str(off))));
