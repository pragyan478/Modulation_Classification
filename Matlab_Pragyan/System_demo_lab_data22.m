...
filename =".\New\A_8qam_32ksps_SR256ksps_CR180064000hz_1.iq";
...
total_power=RX_SPS*mean(abs(rxSig.^2));
...
[Offset1,StrongerUser,WeakerUser,ph1,ph2] = SIC2(rxSig_1',Beta1_est,RX_SPS,rx_filter_span,fo(2),fo(1),h12,h11,M,floor(e2*RX_SPS));
