function data = data_generation_25classes(N, snr)
data = [];
runs=1;
...
for j=1:length(h1) %doubt?
    ...
    for q=1:runs
        ...
        t1 = 2*ModData_bpsk1*exp(i*theta1) + ModData_bpsk2*exp(i*theta2);
        t2 = 2*ModData_bpsk1*exp(i*theta1) + ModData_qpsk1*exp(i*theta2);
        t3 = 2*ModData_bpsk1*exp(i*theta1) + ModData_8psk1*exp(i*theta2);
        t4 = 2*ModData_bpsk1*exp(i*theta1) + ModData_8qam1*exp(i*theta2);
        t5 = 2*ModData_bpsk1*exp(i*theta1) + ModData_16qam1*exp(i*theta2);
        
        
        t6 = 2*ModData_qpsk1*exp(i*theta1) + ModData_bpsk1*exp(i*theta2);
        t7 = 2*ModData_qpsk1*exp(i*theta1) + ModData_qpsk2*exp(i*theta2);
        t8 = 2*ModData_qpsk1*exp(i*theta1) + ModData_8psk1*exp(i*theta2);
        t9 = 2*ModData_qpsk1*exp(i*theta1) + ModData_8qam1*exp(i*theta2);
        t10 = 2*ModData_qpsk1*exp(i*theta1) + ModData_16qam1*exp(i*theta2);
        
        t11 = 2*ModData_8psk1*exp(i*theta1) + ModData_bpsk1*exp(i*theta2);
        t12 = 2*ModData_8psk1*exp(i*theta1) + ModData_qpsk1*exp(i*theta2);
        t13 = 2*ModData_8psk1*exp(i*theta1) + ModData_8psk2*exp(i*theta2);
        t14 = 2*ModData_8psk1*exp(i*theta1) + ModData_8qam1*exp(i*theta2);
        t15 = 2*ModData_8psk1*exp(i*theta1) + ModData_16qam1*exp(i*theta2);
        
        
        t16 = 2*ModData_8qam1*exp(i*theta1) + ModData_bpsk1*exp(i*theta2);
        t17 = 2*ModData_8qam1*exp(i*theta1) + ModData_qpsk1*exp(i*theta2);
        t18 = 2*ModData_8qam1*exp(i*theta1) + ModData_8psk1*exp(i*theta2);
        t19 = 2*ModData_8qam1*exp(i*theta1) + ModData_8qam2*exp(i*theta2);
        t20 = 2*ModData_8qam1*exp(i*theta1) + ModData_16qam1*exp(i*theta2);
        
        
        t21 = 2*ModData_16qam1*exp(i*theta1) + ModData_bpsk1*exp(i*theta2);
        t22 = 2*ModData_16qam1*exp(i*theta1) + ModData_qpsk1*exp(i*theta2);
        t23 = 2*ModData_16qam1*exp(i*theta1) + ModData_8psk1*exp(i*theta2);
        t24 = 2*ModData_16qam1*exp(i*theta1) + ModData_8qam1*exp(i*theta2);
        t25 = 2*ModData_16qam1*exp(i*theta1) + ModData_16qam2*exp(i*theta2);
