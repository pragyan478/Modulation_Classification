...
h11 =(1/sqrt(2))*(randn(1,1)+ 1j*randn(1));
%h12 = (1/sqrt(2))*(raylrnd(1)+ 1j*raylrnd(1));
h12 = h11;
% theta1 = angle(h11);
% theta2 = angle(h12);
P_f=4;P_n=1;
...
for j=1:length(h1) %doubt?
    ...
    for q=1:runs
        ...
        t1 = h11*(ModData_bpsk1*sqrt(P_f) + ModData_bpsk2*sqrt(P_n));
        t2 = h11*(ModData_bpsk1*sqrt(P_f) + ModData_qpsk1*sqrt(P_n));
        t3 = h11*(ModData_bpsk1*sqrt(P_f) + ModData_8psk1*sqrt(P_n));
        t4 = h11*(ModData_bpsk1*sqrt(P_f) + ModData_8qam1*sqrt(P_n));
        t5 = h11*(ModData_bpsk1*sqrt(P_f) + ModData_16qam1*sqrt(P_n));
        
        
        t6 = h11*(ModData_qpsk1*sqrt(P_f) + ModData_bpsk1*sqrt(P_n));
        t7 = h11*(ModData_qpsk1*sqrt(P_f) + ModData_qpsk2*sqrt(P_n));
        t8 = h11*(ModData_qpsk1*sqrt(P_f) + ModData_8psk1*sqrt(P_n));
        t9 = h11*(ModData_qpsk1*sqrt(P_f) + ModData_8qam1*sqrt(P_n));
        t10 = h11*(ModData_qpsk1*sqrt(P_f) + ModData_16qam1*sqrt(P_n));
        
        t11 = h11*(ModData_8psk1*sqrt(P_f) + ModData_bpsk1*sqrt(P_n));
        t12 = h11*(ModData_8psk1*sqrt(P_f) + ModData_qpsk1*sqrt(P_n));
        t13 = h11*(ModData_8psk1*sqrt(P_f) + ModData_8psk2*sqrt(P_n));
        t14 = h11*(ModData_8psk1*sqrt(P_f) + ModData_8qam1*sqrt(P_n));
        t15 = h11*(ModData_8psk1*sqrt(P_f) + ModData_16qam1*sqrt(P_n));
        
        
        t16 = h11*(ModData_8qam1*sqrt(P_f) + ModData_bpsk1*sqrt(P_n));
        t17 = h11*(ModData_8qam1*sqrt(P_f) + ModData_qpsk1*sqrt(P_n));
        t18 = h11*(ModData_8qam1*sqrt(P_f) + ModData_8psk1*sqrt(P_n));
        t19 = h11*(ModData_8qam1*sqrt(P_f) + ModData_8qam2*sqrt(P_n));
        t20 = h11*(ModData_8qam1*sqrt(P_f) + ModData_16qam1*sqrt(P_n));
        
        
        t21 = h11*(ModData_16qam1*sqrt(P_f) + ModData_bpsk1*sqrt(P_n));
        t22 = h11*(ModData_16qam1*sqrt(P_f) + ModData_qpsk1*sqrt(P_n));
        t23 = h11*(ModData_16qam1*sqrt(P_f) + ModData_8psk1*sqrt(P_n));
        t24 = h11*(ModData_16qam1*sqrt(P_f) + ModData_8qam1*sqrt(P_n));
        t25 = h11*(ModData_16qam1*sqrt(P_f) + ModData_16qam2*sqrt(P_n));
...
data = [y1, y2, y3, y5, y6,y7,y8, y10, y11, y12, y13, y15, y21, y22, y23, y25];
