...
if E.OptimalK==15
    ...
    cent = cent';
    if(class_17(cent,E.OptimalK)<0.03)
        class=17;
    else
        class=16;
        ...
        if  sum((85 < ss)&(ss < 95))==4
            ...
            if  sum((85 < ss1)&(ss1 < 95)) + sum((85 < ss2)&(ss2 < 95)) + sum((85 < ss3)&(ss3 < 95))+ sum((85 < ss4)&(ss4 < 95))==16
                ...
                if(dis<.2)
                    ...
                    if(class_18_final(cent,E.OptimalK)<0.1)
                        class=18;
                    else
                        class = 11;
...
if E.OptimalK ==32
    ...
    %disp(size(tempp1));
        ...
        if  sum((35 < ss_1)&(ss_1 < 55)) + sum((35 < ss_2)&(ss_2 < 55)) + sum((35 < ss_3)&(ss_3 < 55))+ sum((35 < ss_4)&(ss_4 < 55))==32
            ...
            if(temp_class19(cent32)<0.09)
                        class=19;
            
             else
                if(class_17(cent32,E.OptimalK)<0.025)
                class=17;
                else
                    if(class_18_final(cent32,E.OptimalK)<0.05)
                    class=18;
                    else
                        class = 12;
                    end
...
if E.OptimalK ==64
    ...
    %scatterplot(cent);
     if(temp_class19(cent)<0.12)
        ...
        % class_18_final(cent,E.OptimalK)
        temp = [real(cent),imag(cent)];
    dist = pdist(temp);
    Z = squareform(dist);
     ...
     if  sum((80 < ss1)&(ss1 < 100)) + sum((80 < ss2)&(ss2 < 100)) + sum((80 < ss3)&(ss3 < 100))+ sum((80 < ss4)&(ss4 < 100))>=12
         ...
         ss = mod(ss,360);
             ...
             class = 13;
                 ...
                 if(class_18_final(cent,E.OptimalK)<0.05)
                    class=18;
                 else 
                    class = 14;
                 end
