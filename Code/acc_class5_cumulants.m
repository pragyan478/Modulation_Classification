...
cfo = [0.02 0.015 0.01 0.005 0.001];
%cfo = [0.1 0.08 0.06 0.04];
t1 = 0.5;
t2 =15.1766;
t3 =.5684;
% cfo = [0.001];
...
for snr = 5:35
    ...
    for k = 1:100
        ...
        c1 = cumulants(sig1,t1,t2,t3);
        if c1==1
            accuracy_y1 = accuracy_y1 + 1;
        end
        
        c7 = cumulants(sig7,t1,t2,t3);
        if c7==7
            accuracy_y7 = accuracy_y7 + 1;
        end
        
        c13 = cumulants(sig13,t1,t2,t3);
        if c13==13
            accuracy_y13 = accuracy_y13 + 1;
        end
        
        c19 = cumulants(sig19,t1,t2,t3);
        if c19==19
            accuracy_y19 = accuracy_y19 + 1;
        end
        
        c25 = cumulants(sig25,t1,t2,t3);
        if c25==25
...
legend({'CFO = 0.02','CFO = 0.015','CFO = 0.01','CFO = 0.005','CFO = 0.001'},'Location','southeast')
figure(2)
